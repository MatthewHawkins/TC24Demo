...
public class BillingInfo extends Div{
  ...
  public BillingInfo() {
    ...
    subtitle = new Paragraph("Fill the form below in order to send you the order's invoice.");
    ...
    FlexLayout rowTwo = FlexLayout.create(firstName, lastName)
        .horizontal()
        .build();
    rowTwo.setItemBasis("50%", firstName);
    rowTwo.setItemBasis("50%", lastName);

    FlexLayout rowThree = FlexLayout.create(email, phone)
        .horizontal()
        .build();
    rowThree.setItemBasis("50%", email);
    rowThree.setItemBasis("50%", phone);

    FlexLayout rowFour = FlexLayout.create(city, states, zip)
        .horizontal()
        .build();
    rowFour.setItemBasis("50%", city);
    rowFour.setItemBasis("30%", states);
    ...
    mainLayout.add(rowOne, rowTwo, address, rowThree, rowFour, countries, diffAddress, orderNotes, rowSix);
