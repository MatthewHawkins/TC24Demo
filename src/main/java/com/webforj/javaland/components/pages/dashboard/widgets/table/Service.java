...
public final class Service {
  ...
  public static Repository<ProductRecord> getProductRecords() {
    ...
    String[] products = new String[] { "Jones Men's Blue T-Shirt", "Brown Hoodie for Men", "Cut Sleeve Shirt",
        "Blue T-Shirt", "Green T-Shirt", "Heavy Hoodie for Women", "Branded Half Sleeve", "Long Sleeve Shirt" };
